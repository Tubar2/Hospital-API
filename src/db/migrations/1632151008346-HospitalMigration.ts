...
export class HospitalMigration1632151008346 implements MigrationInterface {
    name = 'HospitalMigration1632151008346'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`medicos\`.\`medico\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nome\` varchar(120) NOT NULL, \`crm\` varchar(7) NOT NULL, \`cep\` varchar(11) NOT NULL, \`tel_fixo\` varchar(20) NOT NULL, \`tel_celular\` varchar(20) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`medicos\`.\`especialidade\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nome\` varchar(20) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
